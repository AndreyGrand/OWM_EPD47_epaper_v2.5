...
String City             = "Nizhniy%20Novgorod";                          // Your home city See: http://bulk.openweathermap.org/sample/
String CityUA           = "Нижний Новгород";
String Country          = "RU";                            // Your _ISO-3166-1_two-letter_country_code country code, on OWM find your nearest city and the country code is displayed
                                                           // https://en.wikipedia.org/wiki/List_of_ISO_3166_country_codes
String Language         = "ru";                            // NOTE: Only the weather description is translated by OWM
...
const char* ntpServer   = "ru.pool.ntp.org";             // Or, choose a time server close to you, but in most cases it's best to use pool.ntp.org to find an NTP server
